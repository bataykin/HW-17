...
export class UsersMongoService implements AUserService {
  constructor(
    ...
    protected readonly authUtils: AuthUtilsClass /*        @InjectRepository(User)
  ...
  async create(dto: CreateUserDto) {
    ...
    const isCredentialsExists =
      await this.usersRepository.checkLoginEmailExists(dto.login, dto.email);
